...
'''
		...
		self.assertEqual(
			html,
			'''<div><h1>This <b>is</b> a <i>heading</i></h1><p>There is some regular text going on here now and there will be <i>italics</i> and <b>bold</b> stuff.</p><h2>There will be exposition and quotes</h2><p>There will be gobbldy gook written that will pass down the  ages, improving the lot of no one. Not once. Not ever.</p><p>So sayeth:</p><blockquote><blockquote>That shit <i>Jay</i> said?That was some <b>bullshit</b>.Maddening, it is.</blockquote></blockquote><h2>There will be lists</h2><ul><li>An <b>unordered</b> list item</li><li><i>Another</i> unordered list item</li></ul><h2>There may be numbered lists</h2><ol><li>1. Item 1</li><li>2. <b>Item</b> 2</li><li>3. Item <b>3</b></li><li>4. Item 4</li></ol><h2>Some code</h2><p><code></code><code> #include <stdio.h></code></p><p>int main() { 	printf("Hello, World! "); 	return 0; } <code></code><code></code></p><p>And a final plain, text paragraph.</p></div>'''
		)
